 ...
 *
 */
@Export public final strictfp class S2Polygon implements Exportable, S2Region, Comparable<S2Polygon> {
   ...
   * given list.
   */
  @NoExport public S2Polygon(List<S2Loop> loops) {
    this.loops = Lists.newArrayList();
    this.bound = S2LatLngRect.empty();
   ...
   * Copy constructor.
   */
  @NoExport public S2Polygon(S2Loop loop) {
    this.loops = Lists.newArrayList();
  ...
  public static S2Polygon fromLoop(S2Loop loop) {
