 ...
 *
 */
@Export public strictfp class S2EdgeUtil implements Exportable {
  /**
   ...
   */
  @Export public static class EdgeCrosser implements Exportable {
    ...
    public static EdgeCrosser create(S2Point a, S2Point b, S2Point c) {
      return new EdgeCrosser(a, b, c);
    }
   ...
   */
  @Export public static class RectBounder implements Exportable {
   ...
   */
  @Export public static class XYZPruner implements Exportable {
   ...
   */
  @Export public static class LongitudePruner implements Exportable {
  ...
  @Export public static class WedgeContains implements Exportable, WedgeRelation {
    /**
  ...
  @Export public static class WedgeIntersects implements Exportable, WedgeRelation {
    /**
     * Given two edge chains (see WedgeRelation above), this function returns -1
  ...
  @Export public static class WedgeContainsOrIntersects implements Exportable, WedgeRelation {
    /**
     * Given two edge chains (see WedgeRelation above), this function returns +1
  ...
  @Export public static class WedgeContainsOrCrosses implements Exportable, WedgeRelation {
    /**
     * Given two edge chains (see WedgeRelation above), this function returns +1
