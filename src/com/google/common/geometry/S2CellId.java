 ...
 *
 */
@Export public final strictfp class S2CellId implements Exportable, Comparable<S2CellId> {
  ...
  @NoExport public static final long MAX_UNSIGNED = -1L; // Equivalent to 0xffffffffffffffffL
  ...
  @NoExport public S2CellId(long id) {
    this.id = id;
  }
