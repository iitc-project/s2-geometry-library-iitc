...
@Export public final strictfp class S2Loop implements Exportable, S2Region, Comparable<S2Loop> {
   ...
   * @param vertices
   */
  @NoExport public S2Loop(final List<S2Point> vertices) {
   ...
   */
  @NoExport public S2Loop(S2Cell cell) {
  ...
  public S2Loop(S2Loop src) {
    ...
    this.vertices = Utils.cloneArray(src.vertices);
  ...
  public static S2Loop fromVertices(List<S2Point> vertices) {
    return new S2Loop(vertices);
  }
  public static S2Loop fromCell(S2Cell cell) {
    return new S2Loop(cell);
  }
        ...
        if (a1 != b2 && a2 != b1 && a1 != b1) {
          ...
          if (crosses ) {
            ...
            log.info("Edge locations in degrees: " + 
                ...
                new S2LatLng(vertex(a2)).toStringDegrees() + " and " +
