...
@Export public final strictfp class S2Cell implements Exportable, S2Region {
   ...
   */
  @NoExport public S2Cell(S2CellId id) {
    init(id);
  }
  ...
  // Convenience methods.
  @NoExport public S2Cell(S2Point p) {
    init(S2CellId.fromPoint(p));
  }

  @NoExport public S2Cell(S2LatLng ll) {
    init(S2CellId.fromLatLng(ll));
  }

  public S2Cell(Object obj) {
    this(obj instanceof S2CellId ? (S2CellId) obj
      : (obj instanceof S2Point  ? S2CellId.fromPoint((S2Point) obj)
      : (obj instanceof S2LatLng ? S2CellId.fromLatLng((S2LatLng) obj)
      : S2CellId.none())));
  }
  ...
  public S2Region clone() {
    ...
    clone.uv = Utils.cloneArray(this.uv);
